...
class AddExpense  extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(role.equalsIgnoreCase("user"))
        {
            ...
            AddExpense.MyCustomAdapter1 adapter = new AddExpense.MyCustomAdapter1(getApplicationContext(), R.layout.spinner_row, a);
        ...
        addaccount.setOnClickListener(new View.OnClickListener() {
            ...
            {
                new MaterialDialog.Builder(AddExpense.this)
                        .title("Add Account")
                        .content("")
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    allvalid=false;
                    Toast.makeText(getApplicationContext(), "you have entered incorrect value in add expenses", Toast.LENGTH_SHORT).show();
                ...
                if (allvalid) {
                    ...
                    VolleyHelper.postRequestVolley(AddExpense.this, URL_API.AddIncome, hashMap1, RequestCodes.AddExpense, false);
                }
        ...
        if (requestCode == 16) {
            try {
                ...
                if (i == 1) {
                    ...
                    AddExpense.MyCustomAdapter adapter = new AddExpense.MyCustomAdapter(getApplicationContext(), R.layout.spinner_row, arraySpinner);
                    account.setAdapter(adapter);
